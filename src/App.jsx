      ...
      <div className="app">
        ...
        <div className="wrap">
          <div className="hero">
            ...
            <p className="hero-sub">Genera contenido para Instagram y TikTok con IA que entiende de belleza. Los prompts los copias en CapCut IA y el video se hace solo.</p>
